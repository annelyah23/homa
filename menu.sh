...
echo -e "\e[$text PREMIUM-SERVER-SCRIPT-BY-DRGVPN"
echo -e " \e[$line**************************************************************\e[m"
...
echo -e "  \e[$number [•9]\e[m \e[$below •ADD IP [admin only]\e[m"
...
echo -e " \e[$line*************************************************************\e[m"
echo -e "  \e[$below Autoscript By        : 🅹🆂🅿🅷🅰🅽🆃🅾🅼"
echo -e "  \e[$below remode by            : Aqua"
echo -e "  \e[$below creadit to OWNER     : Hasil Senip Group"
echo -e " \e[$line*************************************************************\e[m"
