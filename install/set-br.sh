...
wget -O strt "https://raw.githubusercontent.com/${GitUser}/homa/main/system/strt.sh"
wget -O limit-speed "https://raw.githubusercontent.com/${GitUser}/homa/main/limit-speed.sh"
chmod +x autobackup
chmod +x backup
chmod +x bckp
chmod +x restore
